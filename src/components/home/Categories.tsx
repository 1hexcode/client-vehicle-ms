...
const CATEGORIES = [
  { name: "Lights & Optics", count: "52 Items", icon: Lightbulb, query: "Lights" },
  { name: "Braking System", count: "38 Items", icon: Octagon, query: "Brake" },
  { name: "Exhaust Parts", count: "26 Items", icon: Wind, query: "Exhaust" },
  { name: "Cooling System", count: "19 Items", icon: Snowflake, query: "Cooling" },
  { name: "Car Wheels", count: "44 Items", icon: Disc, query: "Wheel" },
  { name: "Exterior Body", count: "31 Items", icon: Car, query: "Body" },
  { name: "Steering Parts", count: "24 Items", icon: Compass, query: "Steering" },
  { name: "Engine Block", count: "17 Items", icon: Settings2, query: "Engine" },
];
